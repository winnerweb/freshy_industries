<?php
$page_title = 'Freshy Palm';
$additional_css = []; // Plus besoin de freshy_palm_page_style.css - tout est dans freshy_style.css
include 'includes/header.php';
?>

    <section class="freshy-palm-banner freshy-palm-page">
        <div class="banner-left">
            <div class="radial-gradient"></div>
            <img src="images/Barniere freshy palm.webp" alt="Freshy Palm Woman and Food" class="banner-image">
        </div>
    ...
    <section class="product-detail-section freshy-palm-page">
        ...
        <div class="product-info-content">
            ...
            <p>Lorem ipsum dolor sit amet consectetur. Dui at vulputate hendrerit at ultrices proin. Enim maecenas
                volutpat pellentesque pretium magnis arcu pulvinar sodales maecenas. Dignissim porttitor iaculis ut leo
                venenatis sed faucibus.</p>
            <a href="devis.php?product=palm" class="btn-order-now">Commander maintenant</a>
        </div>
    </section>
    <section class="product-detail-section freshy-palm-page">
        <div class="product-image-container">
            <img src="images/huile_epicerie.webp" alt="Huile de palme">
        </div>
        <div class="product-info-content">
    ...
    <section class="product-detail-section freshy-palm-page">
        <div class="product-image-container">
            <img src="images/huile_epicerie.webp" alt="Huile palmiste">
        </div>
        <div class="product-info-content">
            <h2>Huile palmiste</h2>
            <p>Lorem ipsum dolor sit amet consectetur. Dui at vulputate hendrerit at ultrices proin. Enim maecenas
                volutpat pellentesque pretium magnis arcu pulvinar sodales maecenas. Dignissim porttitor iaculis ut leo
                venenatis sed faucibus.</p>
            <p>Lorem ipsum dolor sit amet consectetur. Dui at vulputate hendrerit at ultrices proin. Enim maecenas
